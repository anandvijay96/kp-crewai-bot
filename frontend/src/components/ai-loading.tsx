...
const TASK_SEQUENCES = [
    {
        status: "Discovering blogs",
        lines: [
            "Initializing Google search API...",
            "Scanning for relevant blog posts...",
            "Analyzing blog domains...",
            "Extracting blog metadata...",
            "Filtering by keywords...",
        ],
    },
    {
        status: "Analyzing authority",
        lines: [
            "Calculating domain authority scores...",
            "Evaluating page authority metrics...",
            "Checking backlink profiles...",
            "Analyzing traffic patterns...",
            "Validating content quality...",
            "Assessing comment opportunities...",
            "Running spam risk analysis...",
            "Finalizing quality scores...",
        ],
    },
    {
        status: "Finalizing results",
        lines: [
            "Filtering blogs by DA/PA thresholds...",
            "Ranking by engagement potential...",
            "Storing qualified blogs in database...",
            "Generating content summaries...",
            "Preparing final report...",
            "Optimizing for user display...",
            "Validating search results...",
            "Completing blog discovery...",
        ],
    },
];
